...
const Select=(event)=>{
  ...
  try {  const SavedPostResonse = await fetch("https://18.218.162.154:8443/server/manageSinglePlayPost", {
      method: "POST",
      credentials: "include",
      headers: {
  ...
  return (
    <BoxInsider>
      ...
      <Typography
        ...
        sx={{ margin: "30px" }}
      >
        Dashboard/Manage_Posts_Gallery/Add_manageSinglePlayPost/
      </Typography>
