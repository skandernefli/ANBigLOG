...
const Select=(event)=>{
  ...
  try {  const SavedPostResonse = await fetch("https://18.218.162.154:8443/server/managevideoposts", {
      method: "POST",
      credentials: "include",
      headers: {
  ...
  return (
    <BoxInsider>
      ...
      <Typography
        ...
        sx={{ margin: "30px" }}
      >
          Dashboard/managevideoposts/add_managevideoposts
      </Typography>
