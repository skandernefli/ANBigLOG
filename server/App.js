...
App.use((req, res, next) => {
  var allowedOrigins = ['http://localhost:3000', 'http://localhost:8080', 'http://192.168.1.226:8080',"https://3.145.167.18","http://3.145.167.18","https://www.anguidehub.com"];  var origin = req.headers.origin;
